    ...
    <div class="container-fluid py-4">
        <div class="card">
            <div class="card-header pb-0 px-3">
                <h6 class="mb-0">{{ __('Tambah Pemasok') }}</h6>
            </div>
            <div class="card-body pt-4 p-3">
                ...
                <form action="{{ url('/addpemasok') }}" method="POST" role="form text-left">
                @csrf
                <div class="row">
                        <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="user-name" class="form-control-label">Nama Pemasok</label>
                                <div class="@error('user.pemasok')border border-danger rounded-3 @enderror">
                                    <input name="nama_pemasok" class="form-control" type="text" placeholder="Name"
                                        id="user-name">
                                </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="user.pabrik">Nama Pabrik</label>
                                <div class="@error('user.pabrik')border border-danger rounded-3 @enderror">
                                <select class="form-control" name="nama_pabrik" id="pabrik">
                                </div>
                                @error('user.pabrik') <div class="text-danger">{{ $message }}</div> @enderror
                                <option>PT. Gudang Garam</option>
                                <option>CV. Toys Jaya </option>
                                <option>PT. AQUA Jaya</option>
                                <option>PT. Minyak Jaya Kelapa</option>
                                <option>CV. Kertas Sindu Jaya </option>
                                </select>
                            </div>
                        </div>
