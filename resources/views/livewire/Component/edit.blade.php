            ...
            <div class="row gx-4">
                <div class="col-auto">
                    <div class="avatar avatar-xl position-relative">
                        <img src="../../assets/img/profil.png" alt="..." class="w-100 border-radius-lg shadow-sm">
                        <a href="javascript:;"
    ...
    <div class="container-fluid py-4">
        <div class="card">
            ...
            <div class="card-body pt-4 p-3">
                ...
                <form action="{{ url('/dashboard/' . $row->id_stock) }}" method="POST" role="form text-left">
                ...
                @csrf
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('user.name')border border-danger rounded-3 @enderror">
                                    <input name="nama_stock" class="form-control" type="text" value="{{ $row->nama_stock }}" placeholder="Name"
                                        id="user-name">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('user.jumlah')border border-danger rounded-3 @enderror">
                                    <input name="jumlah_stock" class="form-control" value="{{ $row->jumlah_stock }}" type="number"
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="user.satuan" class="form-control-label">Satuan Stock</label>
                                <div class="@error('user.satuan')border border-danger rounded-3 @enderror">
                                    <input name="satuan_stock" class="form-control" value="{{ $row->satuan_stock }}" type="text"
                                        placeholder="40770888444" id="satuan">
                                </div>
                            </div>
                            </div>
                            <div class="col-md-6">
                            <div class="form-group">
                                <label for="user.satuan" class="form-control-label">Kode Stock</label>
                                <div class="@error('user.satuan')border border-danger rounded-3 @enderror">
                                    <input name="kode_stock" class="form-control" value="{{ $row->kode_stock }}" type="text"
                                        placeholder="40770888444" id="satuan">
                                </div>
                            </div>
