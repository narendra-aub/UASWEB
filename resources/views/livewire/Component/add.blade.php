            ...
            <div class="row gx-4">
                <div class="col-auto">
                    <div class="avatar avatar-xl position-relative">
                        <img src="../assets/img/profile.png" alt="..." class="w-100 border-radius-lg shadow-sm">
                        <a href="javascript:;"
    ...
    <div class="container-fluid py-4">
        <div class="card">
            ...
            <div class="card-body pt-4 p-3">
                ...
                <form action="{{ url('/dashboard') }}" method="POST" role="form text-left">
                @csrf
                <div class="row">
                        <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="user-name" class="form-control-label">Nama Stock</label>
                                <div class="@error('user.name')border border-danger rounded-3 @enderror">
                                    <input name="nama_stock" class="form-control" type="text" placeholder="Name"
                                        id="user-name">
                                </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="user.satuan">Satuan Stock</label>
                                <div class="@error('user.satuan')border border-danger rounded-3 @enderror">
                                <select class="form-control" name="satuan_stock" id="satuan">
                                </div>
                                @error('user.satuan') <div class="text-danger">{{ $message }}</div> @enderror
                                <option>Pack</option>
                                <option>Pcs</option>
                                <option>Box</option>
                                <option>Liter</option>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="user.kode" class="form-control-label">Kode Stock</label>
                                <div class="@error('user.kode')border border-danger rounded-3 @enderror">
                                    <input name="kode_stock" class="form-control" type="text"
                                        placeholder="40770888444" id="kode">
                                </div>
                                @error('user.kode') <div class="text-danger">{{ $message }}</div> @enderror
                            </div>
                        </div>
                    </div> 
