    ...
    <div class="container-fluid py-4">
        <div class="card">
            ...
            <div class="card-body pt-4 p-3">
                ...
                <form action="{{ url('/editpemasok/' . $row->id_pemasok) }}" method="POST" role="form text-left">
                ...
                @csrf
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('user.name')border border-danger rounded-3 @enderror">
                                    <input name="nama_pemasok" class="form-control" type="text" value="{{ $row->nama_pemasok }}" placeholder="Name"
                                        id="user-name">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('user.stock')border border-danger rounded-3 @enderror">
                                    <input name="nama_stock" class="form-control" value="{{ $row->nama_stock }}" type="textx"
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="user.satuan" class="form-control-label">Nama Pabrik</label>
                                <div class="@error('user.satuan')border border-danger rounded-3 @enderror">
                                    <input name="nama_pabrik" class="form-control" value="{{ $row->nama_pabrik }}" type="text"
